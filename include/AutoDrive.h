...
private:
    ...
    void rotateToPosition(GameElement* gameElement, bool ISUSINGGPS = false);
    ...
    void rotateToPosition(std::pair<double,double> finalPosition, bool ISBACKROTATION = false, bool ISUSINGGPS = true);
    ...
    void rotateAndDriveToPosition(GameElement* gameElement, bool ISUSINGGPS = false);
    ...
    void rotateAndDriveToPosition(std::pair<double,double> position, bool ISBACKTOPOSITION, bool ISUSINGGPS = true);
    ...
    void rotateAndShoot(GameElement* goal, double velocityPercent, int numDisksToShoot, bool ISUSINGGPS = true);
